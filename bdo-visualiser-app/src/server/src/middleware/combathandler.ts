    ...
    public async getCombatNewEntryData(): Promise<CombatPageEnumsViewModel> {
        ...
        await new GrindingDataContext().getMostRecent().then((_: GrindingDataEntity) => {
            if(typeof(_) != "undefined") {
                ...
                previousEntry.userClass = new UserClassViewModel(_.userClassId, new ClassNamesEnumViewModel(_.classNameId, _.className, _.fileName), new ClassRolesEnumViewModel(_.classRoleId, _.classRoleName), new CombatTypesEnumViewModel(_.combatTypeId, _.combatTypeName), new GearViewModel(_.gearLabel, _.ap, _.aap, _.dp, _.gearScore), _.classDescription);    
                let agrisBurnt = "";
